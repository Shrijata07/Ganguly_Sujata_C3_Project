...
class RestaurantServiceTest {
    ...
    @BeforeEach
    public void addRestaurantfortesting(){

        Restaurant restaurant = service.addRestaurant("Amelie's cafe","Chennai",LocalTime.parse("10:30:00"),LocalTime.parse("22:00:00"));
        Restaurant restaurant1= service.addRestaurant("Pumpkin Tales","Chennai",LocalTime.parse("12:00:00"),LocalTime.parse("23:00:00"));
